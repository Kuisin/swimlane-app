...
6. **Markdown preview** needs the bundled VSIX (`pnpm run install:cursor-plugin` from the repo, or Install from VSIX under `vscode/`). Rules/skills alone do not render diagrams.
