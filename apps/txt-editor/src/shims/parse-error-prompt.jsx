...
/** Electron GUI-only: no text editor route; offer continue-only parse error handling. */
export function ParseErrorPrompt({ errors, onChooseContinue }) {
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 space-y-1">
          ...
          <p className="text-[11px] font-jp text-amber-200/90 leading-relaxed">
            GUI では安全のため編集できません。外部エディタで .txt を修正するか、プレビューのみ続行してください。
          </p>
        </div>
      </div>
